...
address VARCHAR(255), phoneNumber VARCHAR(255), birthDate date, username VARCHAR(255), password VARCHAR(255), averageRating integer, verified boolean, role VARCHAR(255));
